...
def run_gui():
    ...
    root.geometry("450x780")   # ventana más compacta
    ...
    # ---------- CHECKBOXES ----------
    frame_checks = ttk.LabelFrame(root, text="Boolean options", padding=5)
    frame_checks.pack(padx=8, pady=5, fill="x")
    ...
    var_check1 = tk.BooleanVar(value=False)
    add_row("DSP enabled", ttk.Checkbutton(frame_A, variable=var_check1))
