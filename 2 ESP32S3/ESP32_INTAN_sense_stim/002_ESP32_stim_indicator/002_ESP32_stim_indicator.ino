...
static constexpr size_t SPI_data_send = 35;
...
class MyCallbacks : public BLECharacteristicCallbacks {
  void onWrite(BLECharacteristic *pCharacteristic) override {
    ...
    if (i == max_tokens) { // Validamos cantidad correcta
      ...
      positive_current_magnitude = tokens[17].toInt();
      negative_current_magnitude = tokens[18].toInt();
      step_DAC = (uint16_t)tokens[19].toInt();
...
//       Serial.println("Estimulación ON");
//     }
//   }else{
//     if(previous_state == STIM_ON){
//       previous_state = STIM_OFF;
//       Serial.println("Estimulación OFF");
//     }
//   }
// }
...
void loop() {
  ...
  switch(general_state){
    ...
    case NUEVO_SPI_ENCOLADO: // Nuevo SPI encolado
      ...
      spi_tx_buf[26] = resting_time;
      spi_tx_buf[27] = stimulation_time;
      spi_tx_buf[28] = high_byte_stimulation_on;   // high_byte_stimulation_on
      spi_tx_buf[29] = low_byte_stimulation_on;    // low_byte_stimulation_on
      spi_tx_buf[30] = stimulation_off_time;
      spi_tx_buf[31] = positive_current_magnitude;
      spi_tx_buf[32] = negative_current_magnitude;
      spi_tx_buf[33] = high_byte_step_DAC;         // high_byte_step_DAC
      spi_tx_buf[34] = low_byte_step_DAC;          // low_byte_step_DAC
