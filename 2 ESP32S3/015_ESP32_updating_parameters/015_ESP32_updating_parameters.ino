...
void loop() {
  switch (general_state){
    ...
    case NUEVO_SPI_ENCOLADO: // Nuevo SPI encolado
      ...
      spi_tx_buf[1] = resting_time;               // resting_time
      spi_tx_buf[2] = stimulation_time;           // stimulation_time
      spi_tx_buf[3] = high_byte_stimulation_on;   // high_byte_stimulation_on
      spi_tx_buf[4] = low_byte_stimulation_on;    // low_byte_stimulation_on
      spi_tx_buf[5] = stimulation_off_time;       // stimulation_off_time
      spi_tx_buf[6] = positive_current_magnitude; // positive_current_magnitude
      spi_tx_buf[7] = negative_current_magnitude; // negative_current_magnitude
      spi_tx_buf[8] = high_byte_step_DAC;         // high_byte_step_DAC
      spi_tx_buf[9] = low_byte_step_DAC;          // low_byte_step_DAC
