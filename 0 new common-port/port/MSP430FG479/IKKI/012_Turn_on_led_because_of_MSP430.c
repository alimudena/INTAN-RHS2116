...
//                |  16         P4.2|-> CS for ESP32 -------------------------> - GPIO 15: A3
//                |  41         P3.0|-> Serial Clock Out (UCA0CLK) -----------> - GPIO 16: A2
//                |  75         P2.5|<- Data In (UCA0SOMI) -------------------> - GPIO 17: A1
//                |  76         P2.4|-> Data Out (UCA0SIMO) ------------------> - GPIO 18: A0
//                |  54         P1.4|-> want to send  ------------------------> - GPIO 11: D11  
//                |  57         P1.1|<- allow send  --------------------------> - GPIO 12: D12
...
int main(void)
{
  ...
  enable_ESP32_send_parameters_setup();
  ESP32_ask_send_parameters_setup();
  ...
  while(1){
    ...
    /*
      ...
      endender el led del MSP430 si el ESP32 se lo dice
    
    */

    new_parameters = ESP32_ask_send_parameters();
    while(new_parameters){ // Mientras el esclavo siga teniendo datos para enviar
      new_parameters = ESP32_ask_send_parameters();
