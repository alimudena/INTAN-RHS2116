...
//                |  11         P4.7|-> CS for ESP32 ECG ---------------------> - GPIO 2: RX CS ECG   
//                |  41         P3.0|-> Serial Clock Out (UCA0CLK) -----------> - GPIO 16: A2 SCLK PARAM - GPIO 36: SCK SCLK ECG
//                |  75         P2.5|<- Data In (UCA0SOMI) -------------------> - GPIO 17: A1 MISO PARAM - GPIO 37: MI MISO ECG
//                |  76         P2.4|-> Data Out (UCA0SIMO) ------------------> - GPIO 18: A0 MOSI PARAM - GPIO 35: MO MOSI ECG
