...
int main(void) {
        ...
        */
        ...
        while(1){
                ...
                if(new_parameters_ESP()){
                        new_stimulation_parameters(&INTAN_config);
                        if(!parameters_updated){ // implementar la recepción de datos que se hayan enviado por bluetooth al ESP32 para actualizar los datos de estimulación
                                initialize_INTAN(&INTAN_config);
