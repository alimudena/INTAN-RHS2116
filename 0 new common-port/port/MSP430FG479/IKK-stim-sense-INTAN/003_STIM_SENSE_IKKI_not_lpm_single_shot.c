...
void receive_parameters_ESP32(INTAN_config_struct* INTAN_config){
    ON_ACK_param();
        ...
        */
        ...
        INTAN_config->MASTER_FREQ = 8000000;
        INTAN_config->resting_time = resting_time_seconds*INTAN_config->MASTER_FREQ/divider_value;
        // INTAN_config->resting_time = resting_time_seconds*60*INTAN_config->MASTER_FREQ/divider_value;
        INTAN_config->stimulation_time = (stimulation_time_seconds*INTAN_config->MASTER_FREQ)/(divider_value*1.14);
