...
uint8_t stimulation_time_miliseconds = 0;
...
void receive_parameters_ESP32(INTAN_config_struct* INTAN_config){
    ON_ACK_param();
        ...
        */
        ...
        stimulation_time_miliseconds = UCA0RXBUF;
        ...
        */
        ...
        // INTAN_config->resting_time = resting_time_miliseconds*60*INTAN_config->MASTER_FREQ/divider_value;
