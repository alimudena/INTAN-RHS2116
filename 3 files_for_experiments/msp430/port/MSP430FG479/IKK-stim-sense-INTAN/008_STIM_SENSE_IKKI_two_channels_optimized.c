...
void receive_parameters_ESP32(INTAN_config_struct* INTAN_config){
    ON_ACK_param();
        ...
        */
        ...
        INTAN_config->stimulation_time = (stimulation_time_miliseconds*INTAN_config->MASTER_FREQ)/(divider_value*2000);
      ...
      case ENVIO_INTAN:{ // Estado 1: Muestreo del ECG y envío a través de SPI al ESP32
        ...
        if(new_param){
          ...
          */
          ...
          ON_CS_ESP_PARAM_pin();
          __delay_cycles(CLK_25_CYCLES);
          // debug_send[debug_send_counter++] = contador2++;
          // debug_send[debug_send_counter++] = contador2++;
          // debug_send[debug_send_counter++] = contador2++;
          // debug_send[debug_send_counter++] = contador2++;
          // debug_send[debug_send_counter++] = contador2++;
          ...
          // debug_send[debug_send_counter++] = 0x31;
          // debug_send[debug_send_counter++] = received_channel_value_1_CH1;
          // debug_send[debug_send_counter++] = received_channel_value_2_CH1;
          // debug_send[debug_send_counter++] = 0x71;
          // debug_send[debug_send_counter++] = received_channel_value_1_CH2;
          // debug_send[debug_send_counter++] = received_channel_value_2_CH2;
          if(contador >= 130){
